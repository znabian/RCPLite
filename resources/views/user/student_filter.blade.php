                ...
                <div class="card-body text-right" id="filter" style="display:none" id="frm">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="status">
                                    <small>نام دانش آموز</small>
                                </label>
                                <input class="form-control" type="text" name="name"  id="name" />
                            </div>
                            <div class="col-md-2">
                                <label for="status">
                                    <small>نام خانوادگی دانش آموز</small>
                                </label>
                            ...
                            <div class="col-md-2">
                                <label for="status">
                                    <small>شماره ولی</small>
                                </label>
                                <input class="form-control" type="number" name="father"  id="father" />
                            </div>
                            ...
                            <div class="col-md-2 float-left" >
                                <button  onclick="submitsearch()"  type="submit" class="btn btn-success">جستجو</button>
                            </div>
